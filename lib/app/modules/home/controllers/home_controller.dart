...
class HomeController extends GetxController with GetTickerProviderStateMixin {
  ...
  // void initScrollerControllerLis(){
  //   scrollController.addListener(() {
  //     double pis = scrollController.position.pixels;
  //     if(pis >= 625&& newsListOnTop.value == false){
  //       newsListOnTop.value = false;
  //     }else if(pis <=1625 && newsListOnTop.value == true){
  //       newsListOnTop.value = true;
  //     }
  //
  //   });
  // }
